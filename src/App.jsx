    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">MANGU</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">MANGU's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>I have tried to put together a mini website with my basic skills for you 💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">Yours, PV</h2>
          <p className="final-subtitle">Have a great year ahead and hope I am the reason for it (Most of the time haha)✨</p>
        </section>
      </div>
